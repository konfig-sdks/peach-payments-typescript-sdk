...
/**
 * This class provides a wrapper for network errors when making requests to Payments API inbound
 */
export class PeachPaymentsError extends Error {
  /**
   * The response body
   */
